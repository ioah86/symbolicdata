...
class TestRunTaskOptionsToXMLWriter(unittest.TestCase):
    ...
    def testXMLRep(self):
        ...
        """
        #1.
        rto = RunTaskOptions(7200,1024,8)
        rtowriter = RunTaskOptionsToXMLWriter()
        s = rtowriter.createXMLFromRunTaskOptions(rto).toxml()
        expectedString = """<?xml version="1.0" ?><RunTaskOptions><maxCPU>7200</maxCPU><maxMem>1024</maxMem><maxJobs>8</maxJobs></RunTaskOptions>"""
        ...
        rtowriter = RunTaskOptionsToXMLWriter()
        s = rtowriter.createXMLFromRunTaskOptions(rto).toxml()
        expectedString = """<?xml version="1.0" ?><RunTaskOptions><maxCPU/><maxMem>1024</maxMem><maxJobs>8</maxJobs></RunTaskOptions>"""
        ...
        rtowriter = RunTaskOptionsToXMLWriter()
        s = rtowriter.createXMLFromRunTaskOptions(rto).toxml()
        expectedString = """<?xml version="1.0" ?><RunTaskOptions><maxCPU>3600</maxCPU><maxMem/><maxJobs>8</maxJobs></RunTaskOptions>"""
